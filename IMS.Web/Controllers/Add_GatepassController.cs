...
namespace IMS.Web.Controllers
{
    public class Add_GatepassController : Controller
    {
        ...
        public bool sendGatepassMail(string gatepassID,string status)
        {
            try
            {
                ...
                if (status == "Create Gatepass")
                {
                    ...
                    DirectoryInfo dir = new DirectoryInfo(@"E:\IMSDocs\Gatepasses\" + GPdetails.GatepassID);
                ...
                else if(status == "Approved by Approver")
                {
                    ...
                    var outputpath = @"E:\IMSDocs\Gatepasses\" + gatepassID + "\\" + GPdetails.Gatepass_InvInchargeFileName;
                    if (outputpath != "")
                    {
                ...
                else if (status == "Material Dispatched")
                {
                    ...
                    var outputpath = @"E:\IMSDocs\Gatepasses\" + gatepassID + "\\" + GPdetails.Gatepass_SecurityGuardFileName;
                    if (outputpath != "")
                    {
                        mail.Attachments.Add(new Attachment(outputpath));
                    }
        ...
        {
            ServiceVMSEntities context = new ServiceVMSEntities();
            var OutputPath = @"E:\IMSDocs\Gatepasses\" + model1.GatepassID;
            ...
            {
                string[] oldfilename = Directory.GetFiles(@"E:\IMSDocs\Gatepasses\" + model1.GatepassID);
        ...
        public bool gatepasssignaturePDF(string gatepassID)
        {
            ...
            //var OutputPath = @"E:\IMSDocs\Gatepasses\" + gatepassID +  "\\" + gatepassfilename;
            ...
            //else
            //{
            //    string[] oldfilename = Directory.GetFiles(@"E:\IMSDocs\Gatepasses\" + gatepassID);
            //    foreach (string file1 in oldfilename)
            //    {
            //        System.IO.File.Delete(file1);
            //    }
            ...
            var OutputPath = @"E:\IMSDocs\Gatepasses\" + gatepassID;
        ...
        public JsonResult SaveImage(string ImgStr, string GPID, string role)
        {
            ...
            {
                OutputPath = @"E:\IMSDocs\Signature\" + GPID + "\\" + "Security Guard";
            }
            if (role == "Inventory Incharge")
            {
                OutputPath = @"E:\IMSDocs\Signature\" + GPID + "\\" + "Inventory Incharge";
            }
            ...
            else
            {
                if (role == "Inventory Incharge")
                {
                    string[] oldfilename = Directory.GetFiles(@"E:\IMSDocs\Signature\" + GPID + "\\" + "Inventory Incharge");
                ...
                if (role == "Security Guard")
                {
                    string[] oldfilename = Directory.GetFiles(@"E:\IMSDocs\Signature\" + GPID + "\\" + "Security Guard");
                    foreach (string file in oldfilename)
                    {
                        System.IO.File.Delete(file);
                    }
        ...
        {
            string EmpOutputPath = @"E:\IMSDocs\Signature\Employeesignature\" + role + "\\" + empid;
